...
if __name__ == "__main__":
    ...
    train_dataset = TrainingDataset("SAM-Med2D/Dataset_Demo", image_size=256, mode='train', requires_name=True, point_num=1, mask_num=5)
    print("Dataset:", len(train_dataset))
    train_batch_sampler = DataLoader(dataset=train_dataset, batch_size=2, shuffle=False, num_workers=4)
    ...
    # test_dataset = TestingDataset("SAM-Med2D/Dataset_Demo", image_size = 256, mode='test',  requires_name = True, point_num=1, return_ori_mask=True, prompt_path = None)
    ...
    #         print(batched_image['point_labels'].shape)
    #         print(batched_image['name'])  
    #         print(batched_image["label_path"])
