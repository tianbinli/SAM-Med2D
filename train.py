...
from utils import select_random_points, FocalDiceloss_IoULoss, get_logger, generate_point, setting_prompt_none
...
def parse_args():
    ...
    parser.add_argument('--lr_scheduler', type=str, default=None, help='If activated, warp up the learning from a lower lr to the base_lr')
